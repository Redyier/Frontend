...
export default function ViewPupil() {
  ...
  const downloadFile = async () => {
    try {
      const result = await axios.get(`http://localhost:8080/students/files/${id}`);
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-center">
                  ...
                  <tr>
                    ...
                    <th scope="col" className="border border-black-100 px-6 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <a href={`http://localhost:8080/students/files/${id}`} download target="_blank" rel="noopener noreferrer">
                            <b>Otvori</b>
                            </a>
                    </th>
                  </tr>
