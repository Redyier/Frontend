                ...
                pupils.map((user, index)=>(
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-center">
                        ...
                        <td className="px-6 py-4 text-center ">
                            ...
                            to={`/viewpupil/${user.id}`}>
                            View
                            </Link>
                            <button type="button" className="text-blue-400 border border-blue-400 hover:text-white-300 hover:bg-blue-700 focus:ring-4 focus:outline-white font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-white-600 dark:hover:bg-white-700 dark:focus:ring-white-800 mx-5">
                            Edit
                            </button>
